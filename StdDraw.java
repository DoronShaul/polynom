...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static ArrayList Point;
...
*/
    ...
    *  as an argument. It can handle action keys
    ...
    public static void main(String[] args) {
    	...
    	setCanvasSize(800,800);                           //setting the size of the screen to 800*800.
    ...
    /**
     * @author 308545151.
     * this functions were made by 308545151, as an addition to the existing class. this functions allow us to
